...
namespace Quo_Gin.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        public static GameObject CreateBodyPrefab(string bodyName, string modelName, BodyInfo bodyInfo)
        {
            ...
            GameObject newBodyPrefab = clonedBody.InstantiateClone(bodyName);
        ...
        {
            GameObject newMaster = LegacyResourcesAPI.Load<GameObject>("Prefabs/CharacterMasters/" + masterToCopy + "MonsterMaster").InstantiateClone(masterName, true);
